...
def get_all_paths(start_x, start_y, end_x, end_y, _map):
...
def path_between_points(start_x, start_y, end_x, end_y, map_file_location=None, _map=None):
    ...
    know_list = get_all_paths(start_x, start_y, end_x, end_y, _map)
